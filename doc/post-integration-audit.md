...
| Commit | Upstream commit subject | Mapped integration subject | Triage outcome | Confidence | Evidence | Reviewer needed | Coverage | Final disposition | Follow-up / proof |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `0d5cdd1ec61367830e99b7e8df6e3b9984dd5780` | docker: refactored deb e2e test | unknown | unprocessed | — | — | — | — | — | — |
| `133e7d9b231100642f26de3c6c4bbde5cf11284d` | docker: fixed stage image for ubu2004 | unknown | unprocessed | — | — | — | — | — | — |
| `5bde3a8640b5d53849b77151da459539d19d17e4` | Updated Makefile | unknown | unprocessed | — | — | — | — | — | — |
| `eec50ec3f1508c81c9c0cbf051788c8ae8493d9a` | docker: fix for running image as any user | unknown | unprocessed | — | — | — | — | — | — |
| `0063f8be653bc13fc325f311eaa8f55eeba5bd40` | lftp: handle extra lines before jobs status | unknown | unprocessed | — | — | — | — | — | — |
| `ec6c48aa17214c44da88eb137f6daf6f8e5ddee9` | lftp: fixed a parser error with 2-line chmod | unknown | unprocessed | — | — | — | — | — | — |
| `211704be15b5d9372c0bdfeb2c3f72c69f98f1d8` | Updated to version v0.7.1 | unknown | unprocessed | — | — | — | — | — | — |
| `3e3270eb8c4ccbabde2837af2b53845ab9dbe0ae` | Updated developer readme | unknown | unprocessed | — | — | — | — | — | — |
| `8f2fbc8d5b2abaf884ef13669432e881b2ded56b` | docker: fixed docker guest .ssh path back | unknown | unprocessed | — | — | — | — | — | — |
| `18ad6ce98cd41d581cafa1671f9986943c714b33` | Updated README with docker ssh keys instructions | unknown | unprocessed | — | — | — | — | — | — |
| `5522203e201dcad0fda39b390cc0d07281735c1c` | Minor README fix | unknown | unprocessed | — | — | — | — | — | — |
| `bf23f0fab23b626d0678e2d70eb111955968ce9e` | Updated version to v0.7.2 | unknown | unprocessed | — | — | — | — | — | — |
| `33d0dae09e3cf8ddae71672067094b90890e843b` | docker: fixed scp error with unknown user | unknown | unprocessed | — | — | — | — | — | — |
| `291a694511aaec0b9a97d7e28117e9ef1b3ffd8c` | Updated version to v0.7.3 | unknown | unprocessed | — | — | — | — | — | — |
| `8d6da57c0ddb1f459d0f826b992d3a88f8ace439` | Test remote server instructions in dev readme | unknown | unprocessed | — | — | — | — | — | — |
| `1bccd13657afe83898b1a20d846e88e3317ddbe2` | Py-scanner: recoverable errors from remote scanner | unknown | unprocessed | — | — | — | — | — | — |
| `20a2ade887b29c17f7277dfe270063c8004ee026` | py-scanfs: scan errors printed in a single line | unknown | unprocessed | — | — | — | — | — | — |
| `9ed00ca7c86ceb2c51ddf0ffe7070e7ba92573cf` | py-ssh: more descriptive error messages | unknown | unprocessed | — | — | — | — | — | — |
| `f2d906e10f1f1fd8b6efdacfd681aebe9bb7f852` | py-scanner: more non-recoverable errors | unknown | unprocessed | — | — | — | — | — | — |
| `de964a1c1d5b2e0a9a028a8fb65131ec1986a3f4` | py-controller: send remote scan errors to web | unknown | unprocessed | — | — | — | — | — | — |
| `bc523d75fee1976ebc03d7003e7572c1ab5cfbe7` | py-lftp: fixed parsing out of log line | unknown | unprocessed | — | — | — | — | — | — |
| `49ffdf12b925d9306d50bd4f7a845f67fb826bb3` | docker: updated dockerignore file | unknown | unprocessed | — | — | — | — | — | — |
| `757da155caec8515575faef519395fae19c229ca` | Ng: notification for remote server error | unknown | unprocessed | — | — | — | — | — | — |
| `52b9ebda04b25a6d40cf0376c9416ab2a50efebb` | Py-scanner: remote md5sum only fails on bad ssh | unknown | unprocessed | — | — | — | — | — | — |
| `50f6b45f3cd86b63c499ec6f5ea7a66536ccbe91` | Updated version to v0.8.0 | unknown | unprocessed | — | — | — | — | — | — |
| `d3acc00892246dba42cf222a4875f2e01527fe6d` | Py: fixed python tests for docker | unknown | unprocessed | — | — | — | — | — | — |
| `dbacc3faf89ab1513246cfddb62933d15a337318` | travis: initial config | unknown | unprocessed | — | — | — | — | — | — |
| `8d9a40f3fe3d3cbcd8152d41a9c58358b5f20fc0` | travis: switch dist to ubuntu 18.04 | unknown | unprocessed | — | — | — | — | — | — |
| `d91445ab4efc2240dad1e7a6d2f35707085105bd` | travis: upgrade docker to latest version | unknown | unprocessed | — | — | — | — | — | — |
| `c1d1530fee5db28ca1379a1c2e9c207bb4479890` | travis: different method of upgrading docker | unknown | unprocessed | — | — | — | — | — | — |
| `710ab6920e532ad6db5f10f5a73c1f35d919a15f` | travis: pull external images before docker build | unknown | unprocessed | — | — | — | — | — | — |
| `e5698066491246bd34c2447f69f4eb3c1df9878a` | travis: docker pull needs to be multiple cmds | unknown | unprocessed | — | — | — | — | — | — |
| `a34057a58dbd116f34ffe8447756de3de6859664` | travis: run all tests | unknown | unprocessed | — | — | — | — | — | — |
| `f9b129e8f224d424365df6c5697ead7c3193305c` | travis: plain progress for buildkit | unknown | unprocessed | — | — | — | — | — | — |
| `1a5721e2c55e16a1a94b42e508abf6b3c238c5e0` | docker: e2e tests timeout if app not configured | unknown | unprocessed | — | — | — | — | — | — |
| `3ab8e066f72fb4051a9b55f1446a228687a10785` | make run-e2e-tests exit with error if tests fail | unknown | unprocessed | — | — | — | — | — | — |
| `23064e7de1b86383142e5d87d4b33e83b2841dfc` | python and angular tests error propagate to make | unknown | unprocessed | — | — | — | — | — | — |
| `91e586f0a3ddb631eda3b1c235a68b01bbed0d02` | Made python and angular docker tests less noisy | unknown | unprocessed | — | — | — | — | — | — |
| `891350813ed8ff2dcf49796c2efddab56cdced99` | travis: moved unit tests to before_install | unknown | unprocessed | — | — | — | — | — | — |
| `4238daa13f98bc9855220f7ff2dbd6d82dc2f0a2` | docker: increase pexpect timeout in stage/deb | unknown | unprocessed | — | — | — | — | — | — |
| `25a2a8c5da5d474e99e45595a48577f88ea5add5` | Updated dev readme | unknown | unprocessed | — | — | — | — | — | — |
| `202412af93e584d311415b85753f095cd27a70c3` | py-lftp: increase timeout for lftp tests | unknown | unprocessed | — | — | — | — | — | — |
| `78f7f71f71067c19ad15bedc6008c02ffdb6ce62` | docs: created mkdocs documentation | unknown | unprocessed | — | — | — | — | — | — |
| `6f0528ef43e60432bb479caf908eaa0b0c92a82e` | Updated README | unknown | unprocessed | — | — | — | — | — | — |
