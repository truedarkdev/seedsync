...
| 575 | `50962f4b2e70a53c4abc62a0f6a1a8f88a41e27f` | 2026-04-07 | Promote recommended workflow to front-and-center in docs | adapted locally in current worktree - added a front-and-center Recommended Workflow section to `README.md`, a detailed `Recommended Setup` section to `src/python/docs/usage.md`, and a concise pointer in `src/python/docs/faq.md` with wording aligned to the local `Delete remote files after download` label |
| 576 | `9727d504655afa7991f856677f0cee8e0cf753f2` | 2026-04-07 | Fix hyphenation of 'hard-linked' in usage docs | adapted locally in current worktree - mapped the website-only wording fix to local `src/python/docs/usage.md` by changing the Recommended Setup tip to `hard-linked` |
