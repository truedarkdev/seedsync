...
| Queue authority and stop/resume | Healthy | Final WSL coverage passed all 154 ModelBuilder tests plus four live controller stop/resume, repeat-cycle, missing-remote-window, completion, and restart scenarios. Rebuilt Docker image `sha256:229518b224d3ed5af3620cb2a4b56da209934cbde8cf96610a8fe227a4c63e02` preserved a real 34% stopped checkpoint across 11 Playwright resume samples (minimum 34%), exposed current Downloading speed/ETA, stopped safely again at 35%, and remained browser-responsive without console or page errors. Prior live 4/4/16 topology evidence also proved two-second Stop readiness, parser-valid LFTP checkpoints, coalesced Queue dispatch, and exact path-pair-aware STOP routing. | Fresh as of 2026-08-08. Durable evidence: `tmp/pytest/stop-resume-flicker/verifier/` and `tmp/pytest/stop-checkpoint-verifier/`; the one-connection diagnostic sidecar format remains outside the accepted live 4/4/16 topology. |
