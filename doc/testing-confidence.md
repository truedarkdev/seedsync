...
| Strict Pyright migration | Healthy through phase 2 | Pinned strict-common and default basic Pyright report 0 errors; the common suite passed 168 tests, including malformed JSON/IPC handling and legacy managed-extract marker recovery. Docker rebuild plus authenticated Playwright Dashboard, Settings, and Logs checks passed, then the original app was restored. | Fresh as of 2026-07-12; controller/process/model, web, and global strict phases remain pending. |
