...
| Python unit/backend | Healthy | Green WSL scripted Python full-suite rerun, including the formerly failing extract-process and breadcrumb/config unit slices. | Fresh as of 2026-04-08. |
