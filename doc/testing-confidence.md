...
| Docker release publication | Unknown pending hosted/multi-architecture promotion | The amd64 `truedarkdev/seedsync:0.9.0` candidate is published at digest `sha256:36325c36344a665dd138786cb182ee7004453d91c8eedb67f936a57b3a520a8a` with revision `92d7d054d547c3714af2ebdd21bfc6e2fd627eea`. Docker Hub inspection and a fresh Unraid pull agreed on the digest, architecture, source, revision, and version labels; local Docker/Playwright and private Unraid `fuse.shfs` preflight evidence are green. | Fresh as of 2026-08-02. Do not promote `0.9` or `latest` until the maintainer's live movie upgrade passes; the hosted tested-digest and remaining architecture lanes are still required before treating publication as healthy. |
