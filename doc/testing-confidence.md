...
| Downloaded-time file sorting | Healthy | The established 519-test WSL and 81-spec Dockerized Angular coverage remains current. The 2026-08-08 start-time correction passed 15 focused WSL lifecycle/timestamp tests: a fresh healthy RUNNING state replaces prior recency, resume does not, and completion only backfills an unobserved start. Live Docker/Playwright selected Downloaded Newest, queued a real remote-only 8 MiB file, and observed it move from index 16 to index 0 as soon as it entered Downloading, with the canonical path-pair timestamp persisted and no browser errors. | Fresh as of 2026-08-08. Candidate image `sha256:7e822e06b233c25d162e831226c2c759921f5dd70ef876f8316de67ebe737c9a`; browser evidence is in `tmp/pytest/download-start-time/playwright-live-start.json`. |
