...
| Strict Pyright migration | Healthy for phase 1 | Pinned Pyright 1.1.410 basic reports 0 errors; affected coverage passed 367 tests, common/web/system passed 478, and extract/transfer passed 316 with 34 skips. Docker rebuild plus authenticated Playwright Dashboard, Settings, and Logs checks passed, then the original app was restored. | Fresh as of 2026-07-12; strict mode remains pending in later staged phases. |
