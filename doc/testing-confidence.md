...
| Dockerized Angular build/test | Healthy | Dockerized Angular verifier path passes after the current frontend compatibility updates, including 428/428 Angular tests and a production build; authenticated Playwright Settings confirms the Remote Python Path default copy plus inline-validation/xfer_verify wording. | Supported frontend closure lane. Fresh as of 2026-07-12. |
