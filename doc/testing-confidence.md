...
| Angular files-page large-list virtualization and initial load | Healthy | Focused virtualization coverage remains current. Fresh image `sha256:2af945945b9e26d29f5b0e6c1179551b866ce7d3efcab8736146da3225cf58b2` served Docker-authenticated Playwright at 543 roots/1,552 nodes and 2,000 roots/8,000 nodes with 50 mounted rows, no browser errors, no full-model debug payload, and model-dispatch-to-useful times of 389.1 ms and 484.7 ms. Sort/filter stayed within 150 ms at both scales. | Reviewer and verifier passed; this internal performance change does not alter visible UI. Fresh as of 2026-08-03. Durable evidence: `tmp/pytest/large-model-initial-load-latency/verifier/browser-candidate/browser-baseline-summary.json`; prior interaction/scroll evidence remains at `tmp/virtualized-files-final-verifier/final/live-clone/summary.json`. |
