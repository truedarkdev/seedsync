...
# Fixed finalization substages.  These names are deliberately closed-world;
# they describe only updater control-flow boundaries and carry no runtime
# labels, identities, paths, or payload data.
DURATION_MODEL_UPDATE_FINALIZATION_PAIR_CANDIDATE_COMPOSITION = \
    "model_update_finalization_pair_candidate_composition"
DURATION_MODEL_UPDATE_FINALIZATION_LIFECYCLE_DIFF = "model_update_finalization_lifecycle_diff"
DURATION_MODEL_UPDATE_FINALIZATION_LIFECYCLE_DIFF_CONSTRUCTION = \
    "model_update_finalization_lifecycle_diff_construction"
DURATION_MODEL_UPDATE_FINALIZATION_LIFECYCLE_DIFF_APPLICATION = \
    "model_update_finalization_lifecycle_diff_application"
DURATION_MODEL_UPDATE_FINALIZATION_COMPLETION_GATE_PHYSICAL_PROOF = \
    "model_update_finalization_completion_gate_physical_proof"
DURATION_MODEL_UPDATE_FINALIZATION_MARKER_RECONCILIATION = "model_update_finalization_marker_reconciliation"
DURATION_MODEL_UPDATE_FINALIZATION_PAIR_ADOPTION = "model_update_finalization_pair_adoption"
DURATION_MODEL_UPDATE_FINALIZATION_FULL_ADOPTION = "model_update_finalization_full_adoption"
DURATION_MODEL_UPDATE_FINALIZATION_COMMAND_IDENTITY_REFRESH = \
    "model_update_finalization_command_identity_refresh"
DURATION_MODEL_UPDATE_FINALIZATION_OVERLAY_CLEAR = "model_update_finalization_overlay_clear"
DURATION_MODEL_UPDATE_FINALIZATION_OVERLAY_REBASE = "model_update_finalization_overlay_rebase"
DURATION_MODEL_UPDATE_FINALIZATION_MODEL_LOCK_WAIT = "model_update_finalization_model_lock_wait"
DURATION_MODEL_UPDATE_FINALIZATION_MODEL_LOCK_HOLD = "model_update_finalization_model_lock_hold"
...
COUNTER_PAIR_SAFETY_REJECT_STATUS_ONLY_NAME = "pair_safety_reject_status_only_name"
COUNTER_PAIR_SAFETY_REJECT_ACTIVE_ONLY_NAME = "pair_safety_reject_active_only_name"
...
_ATTRIBUTION_GROUPS = {
    ...
    "model_update_build_finalization": (
        DURATION_MODEL_UPDATE_BUILD_FINALIZATION,
        (
            DURATION_MODEL_UPDATE_FINALIZATION_PAIR_CANDIDATE_COMPOSITION,
            DURATION_MODEL_UPDATE_FINALIZATION_LIFECYCLE_DIFF,
