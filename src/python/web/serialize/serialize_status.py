...
class SerializeStatusJson:
    ...
    def status(status: Status) -> str:
        json_dict: dict[str, object] = {
            SerializeStatusJson.__KEY_SERVER: {
                SerializeStatusJson.__KEY_SERVER_UP: status.server.up,
                SerializeStatusJson.__KEY_SERVER_ERROR_MSG: status.server.error_msg,
            },
            SerializeStatusJson.__KEY_CONTROLLER: {
                SerializeStatusJson.__KEY_CONTROLLER_LATEST_LOCAL_SCAN_TIME:
