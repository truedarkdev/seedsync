...
class TestPerformanceDiagnosticsCollector(unittest.TestCase):
    ...
    def test_rebuild_reason_counters_are_fixed_and_bounded(self):
        ...
        collector.increment("controller_job_wakes", 3)
        collector.increment("controller_job_wake_startup")
        collector.increment("controller_job_wake_event")
        ...
        collector.increment(COUNTER_PAIR_SAFETY_REJECT_SOURCE_DUPLICATE)
        collector.increment(COUNTER_PAIR_SAFETY_REJECT_STATUS_ONLY_NAME)
        collector.increment(COUNTER_PAIR_SAFETY_REJECT_ACTIVE_ONLY_NAME)
        ...
        self.assertEqual(3, snapshot["counters"]["controller_job_wakes"])
        self.assertEqual(1, snapshot["counters"]["controller_job_wake_startup"])
        self.assertEqual(1, snapshot["counters"]["controller_job_wake_event"])
        ...
        self.assertEqual(1, snapshot["counters"][COUNTER_PAIR_SAFETY_REJECT_SOURCE_DUPLICATE])
        self.assertEqual(1, snapshot["counters"][COUNTER_PAIR_SAFETY_REJECT_STATUS_ONLY_NAME])
        self.assertEqual(1, snapshot["counters"][COUNTER_PAIR_SAFETY_REJECT_ACTIVE_ONLY_NAME])
