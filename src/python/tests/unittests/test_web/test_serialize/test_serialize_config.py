...
class TestSerializeConfig(unittest.TestCase):
    ...
    def test_restart_required_metadata_matches_config_shape_and_hot_fields(self):
        ...
        self.assertEqual(True, out_dict["restart_required"]["general"]["breadcrumb_trace_memory_budget_bytes"])
        self.assertEqual(True, out_dict["restart_required"]["general"]["breadcrumb_trace_max_entries"])
        self.assertEqual(True, out_dict["restart_required"]["general"]["breadcrumb_trace_policy"])
